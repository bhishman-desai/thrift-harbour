...
public class AuthenticationController {
   ...
   * @return A {@code ResponseEntity<ForgotPassResponse>} object containing the response message of
   *     the request.
   */
  @PostMapping("/forgot-password")
  public ResponseEntity<ForgotPassResponse> forgetPassword(
  ...
  /**
   * Verifies a password reset token that has been sent to a user as part of the password reset
   * process.
   *
   ...
   *
   * @param resetPassRequest The request body containing the necessary information for resetting the
   *     password.
   * @return A {@code ResponseEntity<Object>} object that contains the message of the reset password
   *     operation.
   */
