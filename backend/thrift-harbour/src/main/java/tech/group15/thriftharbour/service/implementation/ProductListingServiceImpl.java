...
public class ProductListingServiceImpl implements ProductListingService {
    ...
    public ImmediateSaleListingCreationResponse createImmediateSaleListing(
        ...
        ImmediateSaleListing immediateSaleListing = ImmediateSaleListing.builder()
        ...
        for (int iter = 0; iter < productImages.size(); ++iter) {
            ...
            String uniqueFileName = FileUtils.generateUniqueFileNameForImage(
            ...
            int returnCode = uploadSingleImage(
                    productImage,
            ...
            if (returnCode == HttpStatusCode.OK) {
                ...
                ImmediateSaleImage immediateSaleImage = ImmediateSaleImage.builder()
    ...
    public AuctionSaleListingCreationResponse createAuctionSaleListing(
        ...
        AuctionSaleListing auctionSaleListing = AuctionSaleListing.builder()
        ...
        for (int iter = 0; iter < productImages.size(); ++iter) {
            ...
            if (returnCode == HttpStatusCode.OK) {
                ...
                AuctionSaleImage auctionSaleImage = AuctionSaleImage.builder()
    ...
    public GetListingImageResponse findAllImmediateSaleListingImagesByID(String listingID) {
        List<ImmediateSaleImage> productImages = immediateSaleImageRepository.getAllByImmediateSaleListingID(listingID);
    ...
    public GetListingImageResponse findAllAuctionSaleListingImagesByID(String listingID) {
        List<AuctionSaleImage> productImages = auctionSaleImageRepository.findAllByAuctionSaleListingID(listingID);
        return GetListingImageResponse.builder()
                .listingId(listingID)
    ...
    public List<ApprovedImmediateSaleListingForAdminResponse> findAllApprovedImmediateSaleListing() {
        ...
        List<ImmediateSaleListing> immediateSaleListings = immediateSaleListingRepository
                .findAllApprovedImmediateSaleListing();
        ...
        for (ImmediateSaleListing immediateSale : immediateSaleListings) {
            ...
            List<ImmediateSaleImage> productImages = immediateSaleImageRepository.getAllByImmediateSaleListingID(
                    immediateSale.getImmediateSaleListingID());
    ...
    public List<DeniedImmediateSaleListingForAdminResponse> findAllDeniedImmediateSaleListing() {
        ...
        List<ImmediateSaleListing> immediateSaleListings = immediateSaleListingRepository
                .findAllDeniedImmediateSaleListing();
    ...
    public List<ApprovedAuctionSaleListingForAdminResponse> findAllApprovedAuctionSaleListing() {
        ...
        List<AuctionSaleListing> auctionSaleListings = auctionSaleListingRepository.findAllApprovedAuctionSaleListing();
        ...
        for (AuctionSaleListing auctionSale : auctionSaleListings) {
            ...
            List<AuctionSaleImage> productImages = auctionSaleImageRepository.findAllByAuctionSaleListingID(
                    auctionSale.getAuctionSaleListingID());
    ...
    public List<DeniedAuctionSaleListingForAdminResponse> findAllDeniedAuctionSaleListing() {
        ...
        List<AuctionSaleListing> auctionSaleListings = auctionSaleListingRepository.findAllDeniedAuctionSaleListing();
     ...
     * @return n {@code AuctionSaleProductResponse} object containing information of
     *         the auction sale product.
     */
    @Override
    public AuctionSaleProductResponse findAuctionSaleProductDetailsById(String auctionSaleListingID) {
        AuctionSaleListing auctionSaleListing = auctionSaleListingRepository
                .findAuctionSaleProductByID(auctionSaleListingID);
     ...
     *                            user.
     * @return A list of {@code ImmediateSaleListingCreationResponse} objects
     *         representing all immediate sale listings details.
     */
    @Override
    public List<ImmediateSaleListingCreationResponse> findAllImmediateListing(
        ...
        String sellerEmail = jwtService.extractUserNameFromRequestHeaders(authorizationHeader);
        List<ImmediateSaleListing> immediateSaleListingList = immediateSaleListingRepository
                .findAllImmediateSaleListing(sellerEmail);
